# Generated by Django 4.2.5 on 2023-10-09 09:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='The contract email for the contributor.', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('date_edited', models.DateTimeField(help_text='The date and time the review\nwas last edited.', null=True)),
